#!/usr/bin/env python3
"""
SubSpace Development Launcher
Wraps the SubSpace executable with development conveniences like debugging support.
Based on the original Naev launcher.
"""
import os
import signal
import subprocess
...
subprocess.run([sys.executable, os.path.join(source_root, "meson.py"), "compile", "-C", build_root, "subspace-gmo"])
